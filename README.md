...
[![R-CMD-check](https://github.com/lkhenayfis/hidro-clustcens/workflows/R-CMD-check/badge.svg)](https://github.com/lkhenayfis/hidro-clustcens/actions)
[![test-coverage](https://github.com/lkhenayfis/hidro-clustcens/workflows/test-coverage/badge.svg)](https://github.com/lkhenayfis/hidro-clustcens/actions)
<!-- badges: end -->
...
remotes::install_github("lkhenayfis/hidro-clustcens", build_vignettes = FALSE)
```
